...
const Review = (props) => {
    ...
    return (
        ...
        >
            ...
            <Rating name="read-only" value={Number(review.cleanliness)} readOnly />
            <Typography component="legend">Price</Typography>
            <Rating name="read-only" value={Number(review.price)} readOnly />
            <Typography component="legend">Service</Typography>
            <Rating name="read-only" value={Number(review.service)} readOnly />
